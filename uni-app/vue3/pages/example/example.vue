    ...
    <scroll-view :scroll-y="true" style="height: 500px;">
      <view class="page">
        ...
        <view style="margin-bottom: 30px;">
          <uni-popup :ref="el => setRefs(el, 'popup1')" @change="changePopup1">
            <view class="qrcode-box" style="margin-top: 30px;">
              <view class="qrcode">
                <uqrcode
                  canvas-id="qrpopup1"
                  :ref="el => setRefs(el, 'qrpopup1')"
                  :value="text"
                  :size="size"
                  :start="false"
        ...
        <view style="margin-bottom: 30px;">
          <uni-popup :ref="el => setRefs(el, 'popup2')" @change="changePopup2">
            <view class="qrcode-box" style="margin-top: 30px;">
              <view class="qrcode">
                <uqrcode
                  canvas-id="qrpopup2"
                  :ref="el => setRefs(el, 'qrpopup2')"
                  :value="text"
                  :size="size"
                  :start="true"
...
const make = refName => refs[refName].make();

const remake = refName => refs[refName].remake();
...
const showPopup = refName => {
  refs[refName].open('center');
};

const closePopup = refName => {
  refs[refName].close();
};

const changePopup1 = e => {
  if (e.show) {
    setTimeout(() => {
      refs.qrpopup1.make();
    }, 150);
